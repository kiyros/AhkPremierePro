...
; c:: MsgBox "You pressed C while premiere pro is active."
; Creates a hotkey that works only in Notepad.
...
; Click and hold scale for premiere pro
^!s:: {
	scale_image := "scale.png"
...
; click and hold poition x
^!x:: {
    MouseGetPos &xpos, &ypos 
	position_image := "position.png"
...
; !2:: ;generic
; 	preset("undertale top text")
; 	return

; !3:: ;generic
; 	preset("undertale bottom text")
; 	return
